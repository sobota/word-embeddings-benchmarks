...
def test_logreglearn():
    ...
    _generate_figure(f_f1score, 'TEST FIGURE', norms_path='../experiments/CSLB/norms.dat', fig_path=save_fig_path)
...
def test_figure_generation():
    ...
    _generate_figure(feature_f1, norms_path='../experiments/CSLB/norms.dat', fig_path=save_fig_path, show_visual=False,
